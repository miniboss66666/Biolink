...
const i18n = {
    de: {
        ...
        greet: (name) => `Hallo ${name}! Ich heiße Pham Minh Quang (Pham ist mein Nachname). Aber du kannst mich einfach P (oder Miniboss) nennen. Willkommen in meiner Ecke!`,
        lblHeight: "Größe",
        lblBorn: "Geburtsjahr",
        lblNat: "Nationalität",
    ...
    vi: {
        ...
        greet: (name) => `Chào ${name}! Tôi tên là Phạm Minh Quang (Phạm là họ của tôi). Bạn có thể gọi tôi là P (hoặc Miniboss). Rất vui được gặp bạn!`,
        lblHeight: "Chiều cao",
        lblBorn: "Năm sinh",
        lblNat: "Quốc tịch",
        lblAnimals: "Động vật",
    ...
    en: {
        ...
        greet: (name) => `Hello ${name}! I'm Pham Minh Quang (Pham is my surname). You can call me P (or Miniboss). Welcome to my space!`,
        lblHeight: "Height",
        lblBorn: "Birth Year",
        lblNat: "Nationality",
        lblAnimals: "Animals",
